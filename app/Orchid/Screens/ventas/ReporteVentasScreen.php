...
class ReporteVentasScreen extends Screen
{
    /**
     * Query data.
     *
    ...
    public function query(Request $request): iterable
    {
        ...
        ->selectRaw("sum(lineasv.precio) as total, max(productos.nombre) as producto, sum(lineasv.cantidad) as cantidad")
    ...
    public function layout(): iterable
    {
        return [
            ...
            Layout::table('results', [
                ...
                TD::make('venta')->render(function ($result) {
    ...
    public function filtrar(Request $request) {
        ...
        return redirect()->route('platform.ventas.report', $rango);
    }
}
