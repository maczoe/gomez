...
class EntradasEditScreen extends Screen
{
    public $movimiento;
    ...
    {
        return  $this->movimiento->exists ? 'Ver entrada' : 'Crear nueva entrada';
    }
    ...
    {
        return "Mantenimmiento de entradas de inventario";
    }
    ...
    public function createOrUpdate(Movimiento $movimiento, Request $request)
    {
        ...
        Alert::info('Entrada guardada satifactoriamente.');

        return redirect()->route('platform.entrada.list');
    }
    ...
    public function remove(Movimiento $movimiento)
    {
        ...
        Alert::info('Entrada borrada con exito.');
